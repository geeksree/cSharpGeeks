...
namespace Framework
{
    ...
    /// </summary>
    public class TCDFrameworkException : Exception
    {
        ...
        public TCDFrameworkException(Exception innerException)
            : base()
        {
        ...
        /// <param name="innerException">The inner exception.</param>
        public TCDFrameworkException(string methodName, Exception innerException)
        ...
        public TCDFrameworkException(string errorMessage)
            : base(errorMessage)
        {
        ...
        public TCDFrameworkException(string methodName, string message, Exception innerException)
        ...
        public TCDFrameworkException(SerializationInfo info, StreamingContext context)
            : base(info, context)
        {
